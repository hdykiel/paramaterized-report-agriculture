...
params:
  country:
    ...
    input: select
    choices: ["United States of America", Mexico, Canada]
  crop: "Wheat"
---
...
- Product managers: identify which product lines to invest in to help farmers overcome challenges such as droughts and desertification and meet the demand of an ever increasing population. K
...
email <-
  ...
  *emphasis*.
  ...
  {add_ggplot(plot_object = plot2, width = 5, height = 5)}
